...
var ButtonBold = function (_Component) {
  _inherits(ButtonBold, _Component);
  ...
  function ButtonBold() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ButtonBold.__proto__ || Object.getPrototypeOf(ButtonBold)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
