...
var ButtonItalic = function (_Component) {
  _inherits(ButtonItalic, _Component);
  ...
  function ButtonItalic() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ButtonItalic.__proto__ || Object.getPrototypeOf(ButtonItalic)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
