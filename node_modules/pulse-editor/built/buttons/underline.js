...
var ButtonUnderline = function (_Component) {
  _inherits(ButtonUnderline, _Component);
  ...
  function ButtonUnderline() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ButtonUnderline.__proto__ || Object.getPrototypeOf(ButtonUnderline)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
...
exports.default = ButtonUnderline;