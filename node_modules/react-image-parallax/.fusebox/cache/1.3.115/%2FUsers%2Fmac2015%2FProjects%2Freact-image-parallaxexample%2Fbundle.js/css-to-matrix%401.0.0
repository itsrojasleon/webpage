FuseBox.pkg("css-to-matrix", {}, function(___scope___){
___scope___.file("dist/css-to-matrix.js", function(exports, require, module, __filename, __dirname){ 
...
return ___scope___.entry = "dist/css-to-matrix.js";
});