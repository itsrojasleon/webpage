FuseBox.pkg("transform-to-matrix", {}, function(___scope___){
___scope___.file("transform-to-matrix.js", function(exports, require, module, __filename, __dirname){ 
...
return ___scope___.entry = "transform-to-matrix.js";
});